/obj/structure/bed/chair/shibari_stand
	...
	var/static/mutable_appearance/shibari_shadow_overlay = mutable_appearance('modular_lewd_items/icons/obj/lewd_structures/shibari_stand.dmi', "shibari_shadow", LOW_OBJ_LAYER)
...
/obj/structure/bed/chair/shibari_stand/MakeRotate()
	return

/obj/structure/bed/chair/shibari_stand/Destroy()
...
/obj/structure/bed/chair/shibari_stand/wrench_act_secondary(mob/living/user, obj/item/weapon)
	return NONE

/obj/structure/bed/chair/shibari_stand/user_unbuckle_mob(mob/living/buckled_mob, mob/living/user)
...
/obj/structure/bed/chair/shibari_stand/atom_deconstruct(disassembled)
	qdel(src)

/obj/structure/bed/chair/shibari_stand/proc/add_rope_overlays(color, taur)
	cut_overlay(shibari_rope_overlay)
	cut_overlay(shibari_rope_overlay_behind)
...
/obj/structure/bed/chair/shibari_stand/post_buckle_mob(mob/living/buckled)
...
/obj/structure/bed/chair/shibari_stand/post_unbuckle_mob(mob/living/buckled)
	buckled.pixel_y = buckled.base_pixel_y
...
/obj/structure/bed/chair/shibari_stand/click_ctrl_shift(mob/user)
...
/obj/structure/bed/chair/shibari_stand/click_ctrl(mob/user)
...
/obj/item/construction_kit/bdsm/shibari
	...
	greyscale_colors = "#bd8fcf"
	resulting_structure = /obj/structure/bed/chair/shibari_stand
