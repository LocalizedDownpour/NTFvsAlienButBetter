/obj/item/clothing/shoes/shibari_legs
	...
	worn_icon = 'modular_lewd_items/icons/mob/lewd_clothing/lewd_shoes.dmi'
	worn_icon_digi = 'modular_lewd_items/icons/mob/lewd_clothing/lewd_shoes_digi.dmi'
	worn_icon_teshari = 'modular_lewd_items/icons/mob/lewd_clothing/lewd_shoes_teshari.dmi'
	armor_protection_flags = 0
			slowdown = 4
	item_flags = DROPDEL
