/obj/item/clothing/gloves/shibari_hands
	...
	worn_icon = 'modular_lewd_items/icons/mob/lewd_clothing/lewd_gloves.dmi'
	worn_icon_teshari = 'modular_lewd_items/icons/mob/lewd_clothing/lewd_gloves_teshari.dmi'
