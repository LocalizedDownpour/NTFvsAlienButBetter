/obj/item/clothing/glasses/sunglasses/blindfold/kinky
	...
	worn_icon_state = "kblindfold_pink"
	inhand_icon_state = "kblindfold_pink"
	icon = 'modular_lewd_items/icons/obj/lewd_clothing/lewd_eyes.dmi'
	icon_override = 'modular_lewd_items/icons/mob/lewd_clothing/lewd_eyes.dmi'
...
//to change model
/obj/item/clothing/glasses/sunglasses/blindfold/kinky/click_alt(mob/user)
	if(color_changed)
...
/obj/item/clothing/glasses/sunglasses/blindfold/kinky/proc/check_menu(mob/living/user)
	if(!istype(user))
		return FALSE
...
/obj/item/clothing/glasses/sunglasses/blindfold/kinky/Initialize(mapload)
	. = ..()
	update_icon_state()
	update_icon()
...
/obj/item/clothing/glasses/sunglasses/blindfold/kinky/update_icon_state()
	. = ..()
	icon_state = "[base_icon_state]_[current_kinkfold_color]"
	worn_icon_state = "[base_icon_state]_[current_kinkfold_color]"
	inhand_icon_state = "[base_icon_state]_[current_kinkfold_color]"

//message when equipping that thing
/obj/item/clothing/glasses/sunglasses/blindfold/kinky/equipped(mob/living/carbon/user, slot)
	. = ..()
	if(src == user.glasses)
...
/obj/item/clothing/glasses/sunglasses/blindfold/kinky/dropped(mob/living/carbon/user)
	. = ..()
	if(src == user.glasses)
