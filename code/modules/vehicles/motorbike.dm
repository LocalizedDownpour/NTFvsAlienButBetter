...
/obj/vehicle/ridden/motorbike
	...
	desc = "An all-terrain vehicle built for traversing rough terrain with ease. \"SFMC CAVALRY\" is stamped on the side of the engine."
...
/obj/item/sidecar
	...
	desc = "A detached sidecar for SFMC motorbikes, which can be attached to them, allowing a second passenger. Use a wrench to dettach the sidecar."
