...
/obj/item/mecha_ammo/vendable/rpg
	...
	desc = "A SFMC mech missile. You probably shouldnt hit the pointy end with anything."
	icon_state = "rpg_ammo"
	rounds = 10
...
/obj/item/mecha_ammo/vendable/flamer
	...
	desc = "A specialized fuel tank designed for refilling SFMC standard issue mech flamers."
