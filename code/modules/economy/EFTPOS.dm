...
/obj/item/eftpos/Initialize(mapload)
	...
	spawn(0)
		...
		R.info += "2. Confirm that your EFTPOS device is connected to your local accounts database. For additional assistance with this step, contact SFMC IT Support<br>"
