...
/obj/item/ammo_magazine/flamer_tank/large/X/deathsquad
	...
	desc = "Using Bluespace technology, SFMC has managed to fit in way more x-fuel than you would ever hope to need in a single lifetime into this specialized tank."
	max_rounds = 225
	current_rounds = 225
	reload_delay = 2 SECONDS
...
/obj/item/ammo_magazine/flamer_tank/vsd
	...
	desc = "A large tank for the Grunwald-Svarog Werke CC/21 Flamer, filled with thick napthal fuel."
...
/obj/item/ammo_magazine/flamer_tank/vsd/blue
	...
	desc = "A large tank for the Grunwald-Svarog Werke CC/21 Flamer, filled with thick napthal X fuel."
