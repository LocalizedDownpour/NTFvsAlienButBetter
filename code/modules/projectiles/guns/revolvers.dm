...
/obj/item/weapon/gun/revolver/mateba
	...
	desc = "The R-24 is the rather rare autorevolver used by the SFMC issued in rather small numbers to backline personnel and officers it uses recoil to spin the cylinder. Uses heavy .454 rounds."
	icon_state = "mateba"
...
/obj/item/weapon/gun/revolver/cmb
	...
	desc = "An automatic revolver chambered in .357 magnum. Commonly issued to SFMC security. It has a burst mode. Currently in trial with other revolvers across Terra and other colonies."
	icon_state = "cmb"
	worn_icon_state = "cmb"
	caliber = CALIBER_357 //codex
	max_chamber_items = 6 //codex
...
/obj/item/weapon/gun/revolver/standard_magnum/fancy/gold
	desc = "A gold plated R-76 magnum, to ensure it's incredibly expensive as well as incredibly impractical. The R-76 magnum is an absolute beast of a handgun used by the SFMC, rumors say it was created as a money laundering scheme by some general due to the sheer inpracticality of this firearm. Hits hard, recommended to be used with its stock attachment. Chambered in 12.7mm."
	icon_state = "g_t76"
...
/obj/item/weapon/gun/revolver/standard_magnum/fancy/nickle
	desc = "A nickle plated R-76 magnum, for a more tasteful finish. The R-76 magnum is an absolute beast of a handgun used by the SFMC, rumors say it was created as a money laundering scheme by some general due to the sheer inpracticality of this firearm. Hits hard, recommended to be used with its stock attachment. Chambered in 12.7mm."
	icon_state = "n_t76"
