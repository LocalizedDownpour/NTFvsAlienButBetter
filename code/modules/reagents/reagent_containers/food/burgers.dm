...
/obj/item/reagent_containers/food/snacks/burger/plain/Initialize(mapload)
	...
	if(prob(1))
		...
		"SFMC Marine Corp? At this time of shift, in this time of year, in this sector of space, localized entirely within your freezer?",
...
/obj/item/reagent_containers/food/snacks/burger/packaged_burger
	...
	desc = "A soggy microwavable burger. There's no time given for how long to cook it. Packaged by the SFMC."
