...
/obj/item/reagent_containers/food/snacks/packaged_burrito
	...
	desc = "A hard microwavable burrito. There's no time given for how long to cook it. Packaged by the SFMC."
	icon = 'icons/obj/items/food/mre.dmi'
	icon_state = "burrito"
	bitesize = 2
	package = TRUE
...
/obj/item/reagent_containers/food/snacks/packaged_hdogs
	...
	desc = "A singular squishy, room temperature, hot dog. There's no time given for how long to cook it, so you assume its probably good to go. Packaged by the SFMC."
	icon = 'icons/obj/items/food/mre.dmi'
	icon_state = "hot_dogs"
	bitesize = 2
	package = TRUE
