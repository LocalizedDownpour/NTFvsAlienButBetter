...
/obj/item/reagent_containers/hypospray/autoinjector/elite //only deathsquad should be able to get this
	...
	desc = "An elite auto-injector loaded with a strong and versatile combination of chemicals, healing most types of damage. Issued almost excusively to the infamous SFMC deathsquads"
	icon_state = "autoinjector-7"
	volume = 37.5
