...
/obj/item/paper/chemistry
	name = "Notice from SFMC"
	info = {"After a routine inspection from the SFMC Chemical Regulatory comittee, we have found that this vessel has, one, an unlicensed access issue that must be amended, and two, nearly double the authorized deployment of chemical vendors. <BR>
