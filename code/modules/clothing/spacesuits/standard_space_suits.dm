...
/obj/item/clothing/head/helmet/space/tgmc
	name = "\improper SFMC Compression Helmet"
	desc = "A high tech, SFMC designed, dark red space suit helmet. Used for maintenance in space."
	icon_state = "void_helm"
	anti_hug = 3

/obj/item/clothing/suit/space/tgmc
	name = "\improper SFMC Compression Suit"
	icon_state = "void"
	desc = "A high tech, SFMC designed, dark red Space suit. Used for maintenance in space."
	slowdown = 1
...
/obj/item/clothing/suit/space/captain
	...
	desc = "A bulky, heavy-duty piece of exclusive SFMC armor. YOU are in charge!"
	icon_state = "caparmor"
