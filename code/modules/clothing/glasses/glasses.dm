...
/obj/item/clothing/glasses/mgoggles
	...
	desc = "Standard issue SFMC goggles. Mostly used to decorate one's helmet."
	icon_state = "mgoggles"
...
/obj/item/clothing/glasses/mgoggles/prescription
	...
	desc = "Standard issue SFMC goggles. Mostly used to decorate one's helmet. Contains prescription lenses in case you weren't sure if they were lame or not."
	prescription = TRUE
