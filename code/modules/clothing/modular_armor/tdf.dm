...
/obj/item/clothing/suit/modular/tdf
	...
	desc = "The Knight medium combat armor is the standard issue armor given to SFMC infantry. Provides good protection without minor impairment to the users mobility. Alt-Click to remove attached items. Use it to toggle the built-in flashlight."
...
/obj/item/clothing/suit/modular/tdf/light
	...
	desc = "The Pawn light combat armor is the standard issue armor given to SFMC recon units and assault units for their mobility. Provides good protection without minor impairment to the users mobility. Alt-Click to remove attached items. Use it to toggle the built-in flashlight."
...
/obj/item/clothing/suit/modular/tdf/robot
	...
	desc = "Heavy armor plating designed for self mounting on SFMC combat robotics. It has self-sealing bolts for mounting on robotic owners inside. Alt-Click to remove attached items. Use it to toggle the built-in flashlight."
...
/obj/item/clothing/head/modular/tdf
	...
	desc = "The standard combat helmet worn by SFMC combat troops. Comes with an integrated hud and AR to provide situational awareness to the wearer."
...
/obj/item/clothing/head/modular/tdf/pyro
	...
	desc = "A bulky helmet with an integrated gas mask and a 'Surt' armor module for fireproofing, fielded to SFMC flamethrower operators."
...
/obj/item/clothing/head/modular/tdf/leader
	...
	desc = "A helmet with additional protection and comfort, designed for SFMC squad leaders and other command units."
...
/obj/item/clothing/head/modular/tdf/robot
	...
	desc = "Heavy armor plating designed for self mounting on the upper half of SFMC combat robotics. It has self-sealing bolts for mounting on robotic owners inside."
	species_exception = list(/datum/species/robot)
