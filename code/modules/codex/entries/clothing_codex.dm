...
/obj/item/clothing/get_mechanics_info()
	...
	if(stamina_regen_mod)
		armor_strings += "<br>This will alter your stamina recovery by [100*stamina_regen_mod]% when worn."
...
/obj/item/armor_module/storage/uniform/get_mechanics_info()
	...
	if(length(storage_datum.storage_type_limits))
		...
		for(var/X in storage_datum.storage_type_limits)
			...
			. += "<br>[initial(B.name)]"
	if(stamina_regen_mod)
		. += "<br>This will alter your stamina recovery by [100*stamina_regen_mod]% when worn."
...
/datum/codex_entry/M3_normal
	...
	lore_text = "This armor was first developed for the SFMC upon requests by General McCoy because he was finding casualties happening due to chest penetrations a bit too common for his liking."
...
/datum/codex_entry/M3_edge
	...
	lore_text = "This armor was first developed for the SFMC upon requests by General McCoy because he was finding casualties happening due to guerrilla machete commandos a bit too common for his liking."
