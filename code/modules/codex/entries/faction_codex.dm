...
/datum/codex_entry/nt_faction
	display_name = "SFMC (faction)"
	lore_text = "SFMC, known informally as NT, is the largest corporation in human space, with facilities mainly in TG space along with a few \
	frontier outposts. They focus on phoron research and mining.<br><br> SFMC was started in in 2057, their main invention back then being a phoron-engine design. \
...
/datum/codex_entry/icc_faction
	...
	which revolted against the Terran Government due to a variety of ideological differences.<br><br> The Confederation's three main planets are Gilgamesh, \
