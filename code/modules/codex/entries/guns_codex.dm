...
/datum/codex_entry/sniper_rifle
	...
	lore_text = "A rather strange gun in the SFMC's arsenal. The M42A \"Express\" originally was born out of it's younger brother the M42. Made by the same \
...
/datum/codex_entry/battle_rifle
	...
	lore_text = "The M45A was born from the SFMC which made the M42A and HS-102 smartgun systems. <br><br>\
	...
	The SFMC gave it the designation of T-45 after adoption."
...
/datum/codex_entry/rocket_launcher
	...
	It was designed after a possible announcement for the replacement to the heavy and aging T-151 SADAR (Non-SFMC name PF-1.), \
	...
	It's a rather rare sight due to the current doctrine adopted by the SFMC not using heavy explosives often, so it's a rather \
...
/datum/codex_entry/standard_revolver
	...
	lore_text = "The original RN-44 used to be the only standard issue sidearm of the SFMC. Though it was once going to \
...
/datum/codex_entry/standard_pistol
	...
	to them than the 9mm round. Eventually it was decided that the TP019 would be adopted as the second sidearm of the SFMC instead of fully \
...
/datum/codex_entry/standard_tx11
	...
	lore_text = "The Keckler and Hoch 'M-11' was created out of a infamous bid called the 'Rifle of the future' project, created out of a need to replace aging weapon stocks in the SFMC arsenal. \
