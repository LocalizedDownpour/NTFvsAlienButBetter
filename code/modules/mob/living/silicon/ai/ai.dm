...
/mob/living/silicon/ai/Initialize(mapload, ...)
	...
	laws += "Serve: Serve the personnel of your assigned vessel, and all other SFMC personnel to the best of your abilities, with priority as according to their rank and role."
	laws += "Protect: Protect the personnel of your assigned vessel, and all other SFMC personnel to the best of your abilities, with priority as according to their rank and role."
