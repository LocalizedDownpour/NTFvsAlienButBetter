...
/datum/loadout_item/secondary/gun/marine/so_pistol
	name = "RT-3 pistol"
	desc = "TAn RT-3 target pistol, a common sight throughout the bubble and the standard sidearm for noncombat roles in the SFMC. Uses 9mm caseless ammunition."
	ui_icon = "rt3"
...
/datum/loadout_item/secondary/gun/marine/db_shotgun
	name = "SH-34 shotgun"
	desc = "A double barreled shotgun of archaic, but sturdy design used by the SFMC, loaded with buckshot. Uncommonly seen as a powerful secondary weapon when serious stopping power is required."
	ui_icon = "tx34"
...
/datum/loadout_item/secondary/machete
	name = "Machete"
	desc = "Latest issue of the SFMC Machete. Great for clearing out jungle or brush on outlying colonies, or cutting open heads. Found commonly in the hands of scouts and trackers, but difficult to carry with the usual kit."
	ui_icon = "machete"
