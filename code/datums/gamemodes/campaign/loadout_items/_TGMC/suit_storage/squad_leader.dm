...
/datum/loadout_item/suit_store/main_gun/squad_leader/carbine
	name = "AR-18"
	desc = "Equipped with red dot sight, extended barrel and plasma pistol. The AR-18 is the main weapon of the SFMCC, offering excellent mobility and impressive close to medium range damage output. \
...
/datum/loadout_item/suit_store/main_gun/squad_leader/carbine/enhanced
	name = "AR-18+"
	desc = "Equipped with red dot sight, extended barrel and plasma pistol. The AR-18 is the main weapon of the SFMC, offering excellent mobility and impressive close to medium range damage output. \
