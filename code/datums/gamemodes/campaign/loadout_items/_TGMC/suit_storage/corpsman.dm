...
/datum/loadout_item/suit_store/main_gun/corpsman/laser_carbine
	name = "Laser carbine"
	desc = "Equipped with a red dot sight and underbarrel grenade launcher. The SFMC laser carbine is the high tech equivilent to the AR-18, with extremely good mobility and handling, and powerful medium range damage. \
...
/datum/loadout_item/suit_store/main_gun/corpsman/carbine/enhanced
	name = "AR-18+"
	desc = "Equipped with mag harness, extended barrel and underbarrel grenade launcher. The AR-18 is the main weapon of the SFMC, offering excellent mobility and impressive close to medium range damage output. \
...
/datum/loadout_item/suit_store/main_gun/corpsman/assault_rifle
	name = "AR-12"
	desc = "Equipped with mag harness, extended barrel and underbarrel grenade launcher. The AR-12 is the former main weapon of the SFMC before it was superseded by the AR-18 for general issue. \
