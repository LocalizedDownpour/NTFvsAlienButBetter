...
/datum/loadout_item/suit_store/main_gun/marine/standard_rifle
	name = "AR-12"
	desc = "Equipped with red dot sight, extended barrel and underbarrel grenade launcher. The AR-12 is the former main weapon of the SFMC before it was superseded by the AR-18 for general issue. \
...
/datum/loadout_item/suit_store/main_gun/marine/laser_rifle
	...
	Uses TE power cells that are shared across all SFMC laser weaponry."
	ui_icon = "ter"
...
/datum/loadout_item/suit_store/main_gun/marine/standard_carbine
	name = "AR-18"
	desc = "Equipped with red dot sight, extended barrel and underbarrel grenade launcher. The AR-18 is the main weapon of the SFMC, offering excellent mobility and impressive close to medium range damage output. \
...
/datum/loadout_item/suit_store/main_gun/marine/combat_rifle
	name = "AR-11"
	desc = "Equipped with a red dot sight and laser sight. The AR-11 is an old rifle of the SFMC, but is now a relatively uncommon sight. \
...
/datum/loadout_item/suit_store/main_gun/marine/skirmish_rifle
	name = "AR-21"
	desc = "Equipped with red dot sight, extended barrel and underbarrel grenade launcher. \
	The AR-21 is an less common rifle in the SFMC, attempting to bridge the gap between lighter, lower calibre rifles and heavier rifles like the BR-64. \
...
/datum/loadout_item/suit_store/main_gun/marine/laser_mg
	...
	but still ultimately excels at apply sustained supporting fire. Uses TE power cells that are shared across all SFMC laser weaponry."
	ui_icon = "tem"
...
/datum/loadout_item/suit_store/main_gun/marine/laser_carbine
	...
	Variable firemodes gives it additional flexibility over its ballistic counterpart. Uses TE power cells that are shared across all SFMC laser weaponry."
...
/datum/loadout_item/suit_store/main_gun/marine/scout_carbine
	name = "AR-18-scout"
	desc = "Equipped with motion detector, extended barrel and underbarrel grenade launcher. The AR-18 is the main weapon of the SFMC, offering excellent mobility and impressive close to medium range damage output. \
...
/datum/loadout_item/suit_store/main_gun/marine/suppressed_carbine
	...
	desc = "Equipped with red dot sight, suppressor and underbarrel grenade launcher. The AR-18 is the main weapon of the SFMC, offering excellent mobility and impressive close to medium range damage output. \
	Compared to the AR-12, it suffers from a comparatively smaller magazine size, and is less effective at longer range. \
