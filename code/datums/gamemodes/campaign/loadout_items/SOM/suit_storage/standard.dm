...
/datum/loadout_item/suit_store/main_gun/som_marine/flamer
	...
	It has good range for a flamer, able to effortly clear out enclosed or defensive positions but lacks the integrated extinguisher of its SFMC equivalent."
