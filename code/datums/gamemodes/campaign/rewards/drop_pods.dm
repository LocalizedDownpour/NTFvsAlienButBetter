...
/datum/campaign_asset/droppod_disable
	...
	detailed_desc = "Ground to Space weapon systems are activated to prevent SFMC close orbit support ships from positioning themselves for drop pod orbital assaults during the current or next mission."
	asset_portrait = /atom/movable/screen/text/screen_text/picture/potrait/pod_officer
