...
/datum/campaign_mission/destroy_mission/teleporter_raid
	...
	hostile_faction_mission_brief = "Emergency scramble order received: SFMC forces detected enroute to lunar Bluespace core facility. \
		...
		Eliminate all SFMC forces you encounter and secure the facility, or hold them off until further reinforcements can arrive."
