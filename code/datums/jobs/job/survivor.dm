...
You appreciate the support of SFMC should you be rescued.
You are not hostile to SFMC, nor you should oppose or disrupt their objective, unless an admin says otherwise.
