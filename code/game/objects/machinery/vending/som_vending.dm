/obj/machinery/vending/weapon/som
	...
	products = list(
		...
		"SMGs" = list(
			...
			/obj/item/ammo_magazine/smg/som/squashhead = -1,
			...
			/obj/item/ammo_magazine/smg/mfsmg = -1,
		...
		"Shotgun" = list(
			...
			/obj/item/ammo_magazine/shotgun/volkite = -1,
			/obj/item/ammo_magazine/handful/volkite = -1,
		),
		"Machinegun" = list(
		...
		"Sidearm" = list(
			...
			/obj/item/weapon/gun/pistol/huf_pp98 = -1,
			/obj/item/ammo_magazine/pistol/standard_pistol/huf_pp98 = -1,
			/obj/item/ammo_magazine/pistol/standard_pistol/huf_pp98/extended = 20,
			/obj/item/weapon/gun/pistol/huf_mf45 = -1,
...
/obj/machinery/vending/som/uniform_supply
	...
	products = list(
		...
		"Intimate & BDSM" = list(
			/obj/item/clothing/sextoy/buttplug = -1,
			/obj/item/clothing/sextoy/nipple_clamps = -1,
			/obj/item/clothing/sextoy/eggvib = -1,
			/obj/item/clothing/sextoy/eggvib/signalvib = -1,
			/obj/item/clothing/sextoy/vibroring = -1,
			/obj/item/clothing/sextoy/dildo = -1,
			/obj/item/clothing/sextoy/dildo/double_dildo = -1,
			/obj/item/clothing/sextoy/dildo/custom_dildo = -1,
			/obj/item/clothing/sextoy/fleshlight = -1,
			/obj/item/clothing/sextoy/magic_wand = -1,
			/obj/item/clothing/sextoy/vibrator = -1,
			/obj/item/clothing/strapon = -1,
			/obj/item/clothing/sextoy/condom = -1,
			/obj/item/condom_pack = -1,
			/obj/item/serviette_pack = -1,
			/obj/item/kinky_shocker = -1,
			/obj/item/clothing/mask/leatherwhip = -1,
			/obj/item/bdsm_candle = -1,
			/obj/item/spanking_pad = -1,
			/obj/item/tickle_feather = -1,
			/obj/item/restraints/handcuffs/lewd = -1,
			/obj/item/clothing/mask/ballgag = -1,
			/obj/item/clothing/mask/ballgag/choking = -1,
			/obj/item/clothing/glasses/sunglasses/blindfold/kinky = -1,
			/obj/item/clothing/ears/earmuffs/kinky_headphones = -1,
			/obj/item/clothing/neck/kink_collar = -1,
			/obj/item/clothing/neck/kink_collar/locked = -1,
			/obj/item/electropack/shockcollar = -1,
			/obj/item/clothing/erp_leash = -1,
			/obj/item/storage/belt/erpbelt = -1,
			/obj/item/clothing/suit/straight_jacket/shackles = -1,
			/obj/item/clothing/suit/straight_jacket/latex_straight_jacket = -1,
			/obj/item/clothing/suit/straight_jacket/kinky_sleepbag = -1,
			/obj/item/clothing/mask/gas/bdsm_mask = -1,
			/obj/item/clothing/head/deprivation_helmet = -1,
			/obj/item/stack/shibari_rope/full = -1,
			/obj/item/stack/shibari_rope/glow/full = -1,
			/obj/item/fancy_pillow = -1,
			...
			/obj/item/clothing/under/latex_catsuit = -1,
			/obj/item/clothing/under/stripper_outfit = -1,
			/obj/item/clothing/under/lewdmaid = -1,
			/obj/item/clothing/under/bunnylewd = -1,
			/obj/item/clothing/suit/corset = -1,
			/obj/item/clothing/head/domina_cap = -1,
			...
			/obj/item/clothing/shoes/latex_heels/ballet_heels = -1,
			/obj/item/reagent_containers/cup/lewd_filter = -1,
			/obj/item/reagent_containers/pill/aphrotoxin = -1,
			/obj/item/reagent_containers/glass/bottle/aphrotoxin = -1,
		),
	)
