...
/obj/machinery/computer/med_data/interact(mob/user)
	...
	var/dat
	if(src.temp)
		dat = "<TT>[src.temp]</TT><BR><BR><A href='byond://?src=[text_ref(src)];temp=1'>Clear Screen</A>"
	else
