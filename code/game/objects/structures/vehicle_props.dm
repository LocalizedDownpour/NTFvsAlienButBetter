...
/obj/structure/prop/urban/vehicles/meridian
	...
	desc = "The 'Mono-Spectra', a mass-produced civilian vehicle for extraterrestrial markets, in and outside of Terra controlled space. Produced by 'Meridian' a car marque and associated operating division of the SFMC."
