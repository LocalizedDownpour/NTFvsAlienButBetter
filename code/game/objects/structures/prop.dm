...
/obj/structure/prop/mainship/mission_planning_system
	...
	desc = "The Mission Planning System IV (MPS IV), a enhancement in mission planning and charting for dropship pilots across the SFMC. Fully capable of customizing their flight paths and loadouts to suit their combat needs."
	icon = 'icons/obj/structures/prop/mainship.dmi'
	icon_state = "mps"
...
/obj/structure/prop/mainship/mapping_computer
	...
	desc = "The Common Mapping Production System version II allows for sensory input from satellites and ship systems to derive planetary maps in a standardized fashion for all SFMC pilots."
	icon = 'icons/obj/structures/prop/mainship.dmi'
...
/obj/structure/prop/mainship/ship_memorial
	...
	desc = "A ship memorial dedicated to the triumphs of the SFMC and the fallen operatives of this ship. On the left there are grand tales of victory etched into the slab. On the right there is a list of famous marines who have fallen in combat serving the TGMC."
...
/obj/structure/prop/mainship/name_stencil
	name = "\improper The SFMC, a SFMC-Class Marine Carrier Arsenal Ship"
...
/obj/structure/prop/mainship/turretprop
	name = "laser turret"
	desc = "A point-defense laser turret supplied by SFMC. This one looks inactive"
	icon = 'icons/obj/structures/prop/mainship.dmi'
...
/obj/structure/prop/mainship/tubeprop
	name = "pneumatic tube"
	desc = "A pneumatic tube commonly used for transportation on SFMC research stations."
	icon = 'icons/obj/structures/prop/mainship.dmi'
...
/obj/prop/mainship/prop/news_tv/tg
	news_stories = "The peace of the Persatuan system was broken as missiles, lasers and coilguns are fired in a fierce naval battle with SFMC and the SOM, the navy was able to secure the jump points being used by the SOM cutting off the remaining SOM ships left in the system.;\
		TDF releases headcam footage being nicknamed 'Martian Bushcutting' showing an infantryman wiping a squad of MMC using only a machete. SFMC pharmaceutical division used the video as a showcase of their advanced combat cocktail mix.;\
		...
		TG Transportation Safety Board has recently released a new list of locations marked as quarantine which includes LV-462, Big Red, and Chigusa. SFMC have been sent to enforce the quarantine and clear the infestation of the recent xenomorph outbreaks, a statement is also included stating the situation is currently under control.;\
		Tadpole class dropships land dropping off more rescue teams to rescue the civilians out of the Hope-3 O'Neill cylinder colony situated on lagrange 1 of Lakota as yesterday a cargo liner collision suspected to be manned by Cult operatives crashed into the colony. Death tolls are currently 45k+ dead and 15k+ injured. This is likely a reprisal attack after the navy began to clamp down on the Cult, more combat ships are being sent to protect especially high value targets.;\
		War correspondent Tim Sholk on the ground in Lolokal station, take it away 'It's a very tense situation here, as you can see most of the stations population have taken refuge near the medical wing caught in the middle of battle against MMC forces and the SFMC, while TG controls the station for now and preparing for evacuation of the-' 'BREACHING CHARGE ON ENGINEERING MARINES MOVE IN AND REEINFORCE, CUT THE FEED NOW!'.;\
...
/obj/prop/mainship/prop/news_tv/som
	news_stories = "Our navy makes a foothold on the Persatuan system as we destroy the imperialists holds in the system, using a mass amount of drones and carrier ships allows us to easily project force everywhere in the system in a matter of a few hours.;\
		...
		SFMC suffers a massive disaster as a cargo liner goes out of control and collides into an O'Neill cylinder colony with many casualties and billions of dollars in cargo lost, a few ship analysts say that the SFMC claim that it was a terrorist attack is false, the maint logs of the ship suggested instead it was a mechanical failure.;\
		We have here Boris Kilo on the frontline of an armed rebellion against TG on the moon of Harvest 'These rebels are sick and tired of the horrible working conditions SFMC has set and the tariff increases TG has done' 'With our wages were just working from meal to meal with no prospect of advancing and they want to increase the damn import tariffs? No enough is enough!' 'Look at this footage we captured so called TDF peacekeepers executing suspected collaborators and shooting into protestors, show it to the whole damn galaxy that they rule this place with fear'.;\
		...
		Tonight's execution! A SFMC spy has been caught and tried today deemed guilty, it shall be a special execution showcasing the MMC's new radiation grenades if everything goes as planned this spy will meet a very painful demise! Execution tonight at 6 on all channels.;\
