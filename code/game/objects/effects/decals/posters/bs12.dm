...
/datum/poster/bay_30
	...
	name = "No ERP"
	desc = "This poster reminds the crew that Eroticism, Rape, and Pornography (but not pin up posters!) are encouraged on SFMC stations."
...
/datum/poster/bay_60
	...
	name = "\improper SFMC logo"
	desc = "A poster depicting the SFMC logo."
