...
/obj/item/portable_vendor/corporate
	name = "\improper SFMC Automated Storage Briefcase"
	desc = "A suitcase-sized automated storage and retrieval system. Designed to efficiently store and selectively dispense small items. This one has the SFMC logo stamped on its side."
	...
	listed_products = list(
		...
		list("SFMC 'Space-Aged' 60-Year Old Whiskey", 20, /obj/item/reagent_containers/food/drinks/bottle/specialwhiskey, "white", "Aged at the bottom of a starship since 2378. You can guess how much it's worth."),
