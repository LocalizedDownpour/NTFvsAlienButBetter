...
/obj/item/weapon/sword/machete
	...
	desc = "Latest issue of the SFMC Machete. Great for clearing out jungle or brush on outlying colonies. Found commonly in the hands of scouts and trackers, but difficult to carry with the usual kit."
	icon_state = "machete"
	worn_icon_state = "machete"
	force = 75
	attack_speed = 12
