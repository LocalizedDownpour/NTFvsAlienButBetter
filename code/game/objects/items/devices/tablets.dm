...
/obj/item/hud_tablet/artillery
	...
	desc = "A handy tablet with a live feed to several SFMC satellites. Provides a view of all artillery on the battlefield. Transmits a video of the impact site whenever a shot is fired, so that hits may be observed by the loader or spotter."
