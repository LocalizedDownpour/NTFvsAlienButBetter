...
/obj/item/book/manual/ripley_build_and_repair
	...
	dat = {"<html>
				...
				<center>
				<br>
				<b style='font-size: 12px;'>SFMC - Building Better Worlds</b>
				...
				<ol>
					...
					<li>Install the internal armor plating (Not included due to SFMC regulations. Can be made using 5 metal sheets).</li>
					<li>Secure the internal armor plating with a wrench.</li>
					<li>Weld the internal armor plating to the chassis.</li>
					<li>Install the external reinforced armor plating (Not included due to SFMC regulations. Can be made using 5 reinforced metal sheets).</li>
				...
				<ul>
					...
					<li>SFMC is determined to ensure the safety of its <s>investments</s> employees.</li>
				</ul>
				</body>
			</html>
			"}
...
/obj/item/book/manual/robotics_cyborgs
	...
	dat = {"<html>
				...
				This useful piece of equipment can be used to immobilize or destroy a cyborg. A word of warning: Cyborgs are expensive pieces of equipment, do not destroy them without good reason, or SFMC may see to it that it never happens again.
				...
				<ol>
					...
					<li>Proceed to a cyborg upload console. SFMC usually places these in the same location as AI upload consoles.</li>
				...
				<h3>WARNING:</h3> Do not detonate a borg without an explicit reason for doing so. Cyborgs are expensive pieces of SFMC equipment, and you may be punished for detonating them without reason.
...
/obj/item/book/manual/security_space_law
	...
	desc = "A set of SFMC guidelines for keeping law and order on their space stations."
...
/obj/item/book/manual/medical_diagnostics_manual
	...
	dat = {"<html>
				...
				<i>The Medical Oath sworn by recognised medical practitioners in the employ of SFMC</i><br>
...
/obj/item/book/manual/nuclear
	...
	dat = {"<html>
				...
				Hello and thank you for choosing the Syndicate for your nuclear information needs. Today's crash course will deal with the operation of a Fusion Class SFMC made Nuclear Device.<br><br>
				...
				Intelligence Analysts believe that normal SFMC procedure is for the Captain to secure the nuclear authentication disk.<br><br>
...
/obj/item/book/manual/orbital_cannon_manual
	name = "SFMC Orbital Bombardment System Manual"
	icon_state = "bookEngineering"
	author = "SFMC R&D"
	title = "SFMC Orbital Bombardment System Manual"
	...
	dat = {"<html>
				...
				<h1>Guide to the SFMC Orbital Bombardment System</h1>
				...
				<ul>
					...
					<li>If the Orbital Cannon Console is broken, contact SFMC HQ for a replacement.</li>
					...
					<li>If a cable of the Orbital Cannon System is severed, contact SFMC HQ for a replacement.</li>
					<li>If Cannon's cable connector breaks, turn off the Orbital Cannon Console and contact SFMC HQ for a replacement.</li>
				</ul>
