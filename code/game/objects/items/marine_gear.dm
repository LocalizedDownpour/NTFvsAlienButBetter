...
/obj/item/storage/box/tgmc_mre
	name = "\improper SFMC meal ready to eat"
...
/obj/item/reagent_containers/food/snacks/protein_pack
	...
	var/static/list/flavor_list = list(
		FACTION_TERRAGOV = list(
			list("stale SFMC protein bar","The most fake looking protein bar you have ever laid eyes on, covered in the a subtitution chocolate. The powder used to make these is a subsitute of a substitute of whey substitute.","#f37d43",list("nutraloafed food" = 1)),
			list("mint SFMC protein bar","A stale old protein bar, with an almost minty freshness to it, but not fresh enough.","#61b36e",list("minty protein" = 1)),
			list("grape SFMC protein bar","Not the good type of grape flavor, tastes like medicine. Fills you up just as well as any protein bar.","#9900ff",list("artifical grape" = 1)),
			list("mystery SFMC protein bar","Some say they have tasted one of these and tasted their favorite childhood meal, especially for squad marines. Most say this tastes like crayons, though it fills like any other protein bar you've seen.","#ffffff",list("crayons" = 1)),
			list("dark chocolate SFMC protein bar","The dark chocolate flavor helps it out a bit, but its still a cheap protein bar.","#5a3b1d",list("bitter dark chocolate" = 1)),
			list("milk chocolate SFMC protein bar","A nice milky addition to a otherwise bland protein taste.","#efc296",list("off flavor milk chocolate"= 1)),
			list("raspberry lime SFMC protein bar","A flavored protein bar, some might say a bit too strongly flavored for their tastes.","#ff0066",list("sour raspberry and lime" = 1)),
			list("chicken SFMC protein bar","Protein bar covered with chicken powder one might find in ramen. Get some extra sodium with your protein.","#cccc00",list("powdered chicken" = 1)),
			list("blueberry SFMC protein bar","A nice blueberry crunch into your otherwise stale and boring protein bar.","#4e39c5",list("blueberry" = 1)),
			list("cement SFMC protein bar", "A gray bar that's allegedly made of cement. It seems to have hardened up. Perhaps it'll make you harden up, too.", "#B2B2B2", list("cement" = 1))
		),
		FACTION_SOM = list(
			...
			list("salted SOM protein bar","A satisfying protein bar, although quite salty. Made with real SFMC tears.","#86a9b8",list("salt" = 1)),
			...
			list("meat SOM protein bar","A surprisingly tasty protein bar made from an unspecified meat. Rumors claiming they're made from reconstituted SFMC personnel have been widely dismissed.","#a7576b",list("pork" = 1)),
...
/obj/item/reagent_containers/food/snacks/req_pizza
	name = "\improper SFMC PFC Jim pizza"
...
/obj/item/reagent_containers/food/snacks/mre_pack
	...
	//trash = /obj/item/trash/SFMCtray
	trash = null
	w_class = WEIGHT_CLASS_SMALL
	icon = 'icons/obj/items/food/mre.dmi'

/obj/item/reagent_containers/food/snacks/mre_pack/meal1
	name = "\improper SFMC Prepared Meal (banana bread)"
...
/obj/item/reagent_containers/food/snacks/mre_pack/meal2
	name = "\improper SFMC Prepared Meal (pork)"
...
/obj/item/reagent_containers/food/snacks/mre_pack/meal3
	name = "\improper SFMC Prepared Meal (spag)"
...
/obj/item/reagent_containers/food/snacks/mre_pack/meal4
	name = "\improper SFMC Prepared Meal (pizza)"
...
/obj/item/reagent_containers/food/snacks/mre_pack/meal5
	name = "\improper SFMC Prepared Meal (monkey)"
...
/obj/item/reagent_containers/food/snacks/mre_pack/meal6
	name = "\improper SFMC Prepared Meal (tofu)"
...
/obj/item/storage/box/nt_mre
	name = "\improper SFMC brand MRE"
	desc = "A prepackaged, long-lasting food box from SFMC Industries.\nOn the box is the SFMC logo, with a slogan surrounding it: \n<b>NINETAILS. BUILDING BETTER LUNCHES</b>"
	icon_state = "mre2"
