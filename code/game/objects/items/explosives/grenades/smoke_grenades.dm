...
/obj/item/explosive/grenade/smokebomb/neuro
	...
	desc = "A smoke grenade containing a concentrated neurotoxin developed by SFMC, supposedly derived from xenomorphs. Banned in some sectors as a chemical weapon, but classed as a less lethal riot control tool by the SFMC."
...
/obj/item/explosive/grenade/smokebomb/neuro/alt
	...
	desc = "A smoke grenade containing a concentrated neurotoxin developed by SFMC, supposedly derived from xenomorphs. Banned in some sectors as a chemical weapon, but classed as a less lethal riot control tool by the SFMC. Version two produces a weaker and smaller smoke cloud that lasts much longer."
	icon_state = "grenade_neuro"
	worn_icon_state = "grenade_neuro"
	hud_state = "grenade_neuro"
	det_time = 4 SECONDS
...
/obj/item/explosive/grenade/smokebomb/acid
	...
	desc = "A grenade set to release a cloud of extremely acidic smoke developed by SFMC, supposedly derived from xenomorphs. Has a shiny acid resistant shell. Its use is considered a warcrime under several treaties, none of which SFMC is a signatory to."
