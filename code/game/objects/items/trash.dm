...
/obj/item/trash/burger
	name = "Burger wrapper"
	icon_state = "burger"
	desc = "A greasy plastic film that once held a Cheeseburger. Packaged by the SFMC."

/obj/item/trash/buritto
	name = "Burrito wrapper"
	icon_state = "burrito"
	desc = "A foul smelling plastic film that once held a microwave burrito. Packaged by the SFMC."

/obj/item/trash/hotdog
	name = "Hotdog wrapper"
	icon_state = "hotdog"
	desc = "A musty plastic film that once held a hotdog. Packaged by the SFMC."
...
/obj/item/trash/mre
	name = "\improper crumbled SFMC MRE"
	desc = "It has done its part for the SFMC. Have you?"
	icon = 'icons/obj/items/trash.dmi'
...
/obj/item/trash/nt_chips
	name = "\improper SFMC Pepper Chips"
	icon_state = "nt_chips_pepper"
	desc = "An oily empty bag that once held SFMC Chips."

/obj/item/trash/nt_chips/pepper
	name = "\improper SFMC Pepper Chips"
	icon_state = "nt_chips_pepper"
	desc = "An oily empty bag that once held SFMC Pepper Chips."
...
/obj/item/trash/crushed_wbottle
	...
	desc = "Overpriced 'Spring' water. Bottled by the SFMC."
