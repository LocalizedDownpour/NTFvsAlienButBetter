...
/obj/item/storage/holster/belt/pistol/g22/Initialize(mapload)
	. = ..()
	var/obj/item/weapon/gun/new_gun = new /obj/item/weapon/gun/pistol/g22(src)
...
/obj/item/storage/holster/belt/pistol/g22_tranq/Initialize(mapload)
	. = ..()
