...
#define FACTION_NANOTRASEN "Archercorp"
...
GLOBAL_LIST_INIT(faction_default_frequency, list(
	FACTION_NEUTRAL = FREQ_CIV_GENERAL,
	FACTION_TERRAGOV = FREQ_COMMON,
	FACTION_NANOTRASEN = FREQ_PMC,
	FACTION_FREELANCERS = FREQ_COLONIST,
	FACTION_SPECFORCE = FREQ_PMC,
	FACTION_RETIRED = FREQ_RETIRED,
	FACTION_DEATHSQUAD = FREQ_DEATHSQUAD,
	FACTION_MOTHELLIAN = FREQ_USL,
	FACTION_ERP = FREQ_ERP,
	FACTION_XENO = FREQ_COLONIST,
	FACTION_CLF = FREQ_COLONIST,
	FACTION_IMP = FREQ_IMPERIAL,
	FACTION_UNKN_MERCS = FREQ_COLONIST,
	FACTION_SECTOIDS = FREQ_SECTOID,
	FACTION_SOM = FREQ_SOM,
	FACTION_ICC = FREQ_ICC,
	FACTION_USL = FREQ_USL,
	FACTION_ALIEN = FREQ_COLONIST,
	FACTION_SPIDER = FREQ_CIV_GENERAL,
...
GLOBAL_LIST_INIT(faction_to_iff, list(
	...
	FACTION_SOM = TGMC_LOYALIST_IFF,
	FACTION_ICC = TGMC_LOYALIST_IFF,
	FACTION_USL = USL_IFF,
...
GLOBAL_LIST_INIT(faction_to_radio, list(
	FACTION_TERRAGOV = FREQ_COMMON,
	FACTION_SOM = FREQ_SOM,
	FACTION_NANOTRASEN = FREQ_PMC,
	FACTION_FREELANCERS = FREQ_COLONIST,
...
GLOBAL_LIST_INIT(faction_to_data_hud, list(
	...
	FACTION_NANOTRASEN = DATA_HUD_SQUAD_TERRAGOV,
...
GLOBAL_LIST_INIT(faction_to_squad_hud, list(
	...
	FACTION_NANOTRASEN = SQUAD_HUD_TERRAGOV,
